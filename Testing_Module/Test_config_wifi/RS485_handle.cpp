...
@return: Slave ID
*/
byte RS485_get_Slave_ID(byte rev_msg[RS485_BUFFER]){
    return rev_msg[0];
}
...
@return: Slave ID
*/
byte RS485_get_Data_Len(byte rev_msg[RS485_BUFFER]){
    return rev_msg[2]/2;
}
...
@return: Slave ID
*/
byte RS_485_get_Data(byte rev_msg[RS485_BUFFER]){
    byte data_len = rev_msg[2]/2;
